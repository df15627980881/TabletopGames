...
//        AutoGenerateDeck.generate(Lists.newArrayList(new RandomPlayer(), new RandomPlayer(), new RandomPlayer()), String.valueOf(LoveLetterGameStrategy.LoveLetterStrategyEnum.MECHANISM.getName()), GameType.valueOf(gameType));
