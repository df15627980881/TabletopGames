...
public class GuideGenerator {
    ...
    public static void main(String[] args) throws InterruptedException {
        AutoGenerateDeck.generate(Lists.newArrayList(new MCTSPlayer(), new MCTSPlayer(), new MCTSPlayer(), new MCTSPlayer()));
        System.out.println("GKDSI" + BlackjackGameStrategy.strategyTextAndGameResults.size());
